...
export const login = async (req, res) => {
  try {
    ...
    // ✅ Cho phép đăng nhập bằng username (phần trước @) hoặc email đầy đủ
    // VD: "admin" sẽ khớp với "admin@hotel.com"
    let user;
    if (email.includes("@")) {
    ...
    // ✅ Trả token về response body (khớp với frontend dùng localStorage)
    res.json({
